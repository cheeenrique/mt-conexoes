...
// Leituras de `ChannelConfig` (lista pra tela de Canais, alerta de canal caído,
// resumo do canal padrão pra régua) moram em `channel-queries.ts` — arquivo
// próprio pra não estourar o orçamento de tamanho deste (01-arquitetura.md).
export type {
  ChannelConfigDTO,
  ChannelDownAlertDTO,
  DefaultChannelSummaryDTO,
} from './channel-queries';
export { listChannelConfigs, getChannelDownAlert, getDefaultChannelSummary } from './channel-queries';
